      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8 animate-fade-in-up">
          <header className="text-center space-y-4">
            <h1 className="text-5xl font-bold tracking-tight text-balance">Edit Event</h1>
            <p className="text-xl text-muted-foreground text-balance">Update your event details</p>
          </header>
